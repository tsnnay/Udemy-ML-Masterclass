...
1-D dataset of baby chicks (male or female) is plotted on a line in \ref{fig:max_margin}, with male on RHS and female on LHS. Visually, data is easily separable.
...
![Maximum Margin Classifer \label{max_margin}](img\max-margin.png)
